        ...
        child: Padding(
          ...
          child: ListView(
            children:  [
              ...
              TextTitle(title: product.name, color: color.text),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  PriceText(price: 'Price: ${product.price}\$', color: Color.fromARGB(255, 0, 160, 3),),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.end,
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      IconButton(onPressed: null, icon: Icon(Platform.isIOS ? Icons.ios_share : Icons.share,color: color.text,)),
                    ],
                  ),
                ],
              ),
